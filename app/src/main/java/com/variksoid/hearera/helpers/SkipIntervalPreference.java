...
public class SkipIntervalPreference extends DialogPreference {
    ...
    public SkipIntervalPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        // Получить dialogTitle, как указано в файле xml
        ...
        // Получить ключ настроек, как указано в файле xml
        ...
        // Получить значение панели поиска по умолчанию, как указано в файле xml со строковым ресурсом
    ...
    protected void onSetInitialValue(@Nullable Object defaultValue) {
        //Прочитайте значение из общих настроек. Используйте значение по умолчанию, если это невозможно.
