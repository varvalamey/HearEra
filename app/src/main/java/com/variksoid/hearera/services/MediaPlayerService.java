...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener, AudioManager.OnAudioFocusChangeListener, SleepTimerStatusListener {
    ...
    public static final String ACTION_PLAY = "com.variksoid.hearera.ACTION_PLAY";
    public static final String ACTION_PAUSE = "com.variksoid.hearera.ACTION_PAUSE";
    public static final String ACTION_TOGGLE_PAUSE = "com.variksoid.hearera.ACTION_TOGGLE_PAUSE";
    public static final String ACTION_BACKWARD = "com.variksoid.hearera.ACTION_BACKWARD";
    public static final String ACTION_FORWARD = "com.variksoid.hearera.ACTION_FORWARD";
    public static final String ACTION_STOP = "com.variksoid.hearera.ACTION_STOP";
    public static final String ACTION_BOOKMARK = "com.variksoid.hearera.ACTION_BOOKMARK";

    public static final String SERVICE_PLAY_STATUS_CHANGE = "com.variksoid.hearera.SERVICE_PLAY_STATUS_CHANGE";
    public static final String SERVICE_MESSAGE_PLAY_STATUS = "com.variksoid.hearera.SERVICE_MESSAGE_PLAYING";
    public static final String SERVICE_NEW_AUDIO = "com.variksoid.hearera.SERVICE_PLAY_STATUS_CHANGE";
    public static final String SERVICE_MESSAGE_NEW_AUDIO = "com.variksoid.hearera.SERVICE_MESSAGE_NEW_AUDIO";
    public static final String MSG_PLAY = "com.variksoid.hearera.SERVICE_PLAY";
    public static final String MSG_PAUSE = "com.variksoid.hearera.SERVICE_PAUSE";
    public static final String MSG_STOP = "com.variksoid.hearera.SERVICE_STOP";

    public static final String BROADCAST_REMOVE_NOTIFICATION = "com.variksoid.hearera.REMOVE_NOTIFICATION";
    public static final String BROADCAST_UNBIND_CURRENT_SERVICE = "com.variksoid.hearera.UNBIND_CURRENT_SERVICE";
    public static final String BROADCAST_RESET = "com.variksoid.hearera.RESET";
    ...
    private static final String CHANNEL_ID = "com.variksoid.hearera.NOTIFICATION_CHANNEL";
    ...
    public void onCreate() {
        ...
        // Установка the shared preferences.
        ...
        // Установка AudioManager
        audioManager = (AudioManager) getSystemService(Context.AUDIO_SERVICE);

        // Установка the LockManager
    ...
    private void initMediaSession() {
        ...
        mediaSession = new MediaSessionCompat(getApplicationContext(), "hearera", mediaButtonReceiverComponentName, mediaButtonReceiverPendingIntent);
    ...
    private void buildNotification() {
        ...
        // Установка intent to start PlayActivity when the notification is clicked
        ...
        // Установка intent to stop service when notification is removed
    ...
    /*
     * Обновить  completed time of the current audio file in the audiofilesтаблицы of the database
     */
    void updateAudioFileStatus() {
        // Обновить  current active audio
        mActiveAudio.setCompletedTime(getCurrentPosition());

        // Обновить  completedTime column of the audiofilesтаблицы
    ...
    /*
     * Обновить  last played column of the albumтаблицы
     */
    ...
    /*
     * Add or Обновить  last and second-to-last play position bookmarks
     */
